...
export default function Document() {
  return (
    <Html lang="en" className="scroll-pt-18 h-full scroll-smooth">
      <Head>
      ...
      <body className="text-on-background bg-gradient-to-b from-white via-neutral-400 to-neutral-500 dark:bg-black dark:bg-none">
        <Main />
        <NextScript />
