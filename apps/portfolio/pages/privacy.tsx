    ...
    <div className="pt-16 pb-4">
      ...
      <div className="space-y-4">
        ...
        <ul className="ml-4 list-disc pl-2">
          ...
          <li>
            Download and use our Facebook application (Jason Ruesch), or any
        ...
        <section id="summaryOfKeyPoints">
          ...
          <p>
            <em>
              ...
              also{' '}
              <Link href="#toc">
                <a className="font-medium text-cyan-500 hover:text-cyan-600 dark:text-violet-400 dark:hover:text-violet-500">
        ...
        <section id="infominors">
          ...
          <p>
            ...
            under age 18, please contact us at privacy@jasonruesch.dev.
          </p>
        </section>
