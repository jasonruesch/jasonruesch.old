...
import { StyleguideColorCards } from './ColorCards';
import { StyleguideTypographyCard } from './TypographyCard';
...
export const StyleguideData = [colors, typography, shadows, buttons];
