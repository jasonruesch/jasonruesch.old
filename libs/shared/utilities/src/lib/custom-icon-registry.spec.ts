...
describe('CustomIconRegistry', () => {
  ...
  it('should get the SVG element for a preloaded icon from the cache', () => {
    const svgSrc = `<svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 24 24"><path d="M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z"/></svg>`;
  ...
  it('should support caching icons with a namespace', () => {
    ...
    let svgElement: SVGElement | undefined;
    registry
      .getNamedSvgIcon('test_icon', 'foo')
      .subscribe((el) => (svgElement = el));
