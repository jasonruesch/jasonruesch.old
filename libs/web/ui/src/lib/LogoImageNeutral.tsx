export interface LogoImageNeutralProps {
  className?: string;
}

export function LogoImageNeutral({ className }: LogoImageNeutralProps) {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      <g transform="matrix(1.2613611714553135,0,0,1.2613611714553135,-8.234481943284555,-3.7538274755242695)">
        <g transform="translate(0,-957.3622)">
          ...
          >
            <stop offset="0" stopColor="var(--color-primary-neutral)" />
            <stop offset="1" stopColor="var(--color-secondary-neutral)" />
          </linearGradient>
          <path
            fillRule="evenodd"
            clipRule="evenodd"
