export const Input = {
  ...
  ':is(.dark input:autofill, .dark input:-webkit-autofill-strong-password, .dark input:-webkit-autofill-strong-password-viewable, .dark input:-webkit-autofill-and-obscured)':
    {
