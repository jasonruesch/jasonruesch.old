      ...
      <g transform="matrix(1.2613611714553135,0,0,1.2613611714553135,-8.234481943284555,-3.7538274755242695)">
        <g transform="translate(0,-957.3622)">
          ...
          >
            <stop
              offset="0"
              className="[stop-color:theme(colors.cyan.500)] dark:[stop-color:theme(colors.violet.400)]"
            />
            <stop
              offset="1"
              className="[stop-color:theme(colors.fuchsia.500)] dark:[stop-color:theme(colors.teal.400)]"
            />
          </linearGradient>
          <path
            fillRule="evenodd"
