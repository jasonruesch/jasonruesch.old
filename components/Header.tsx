...
import avatarDarkImage from '@/images/avatar-dark.png';
  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-cyan-500/0 via-cyan-500/40 to-cyan-500/0 dark:from-violet-400/0 dark:via-violet-400/40 dark:to-violet-400/0" />
        )}
      </Link>
    </li>
  );
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        sizes={large ? '4rem' : '2.25rem'}
        className={clsx(
          'hidden rounded-full bg-zinc-100 object-cover dark:block dark:bg-zinc-800',
          large ? 'h-16 w-16' : 'h-9 w-9'
        )}
        priority
      />
